  ...
  return (
    ...
    transition={{
     ...
     className='relative flex justify-center items-center mt-52'>
        <div className='absolute border border-[#4e4b4b] rounded-full h-[200px] w-[200px] mt-52 animate-ping'/>
        <div className='rounded-full border border-[#333333] h-[300px] w-[300px] absolute mt-52'/>
        <div className='rounded-full border border-[#c4b2b2] h-[500px] w-[500px] absolute mt-52'/>
